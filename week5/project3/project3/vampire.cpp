...
bool Vampire::defend(int dmgAttack) {
    ...
    if (roll == 1) {
        cout << "The defending " << this->getType() << " has " << this->getStrength() << " strength." << endl;
        cout << endl << "The defending " << this->getType() << " used ~~CHARM~~ and completely avoided taking damage." << endl << endl;
