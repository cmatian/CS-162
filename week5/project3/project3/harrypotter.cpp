...
/******************************************************************
 ** Virtual Harry Potter Destructor
 **
...
bool Harrypotter::defend(int dmgAttack) {
    ...
    if(doCombat == false && hogwarts == true) {
        ...
        doCombat = true;
        strength = 20;
        cout << "The defending Harry Potter was slain but managed to use ~~HOGWARTS~~. He came back to life with 20 hitpoints - wicked!" << endl;
    }
